			...
			<div>
              ...
              <div>
                  ...
                  <div  class="wrapper"> <strong>Subject name1:</strong>
					...
					<option value="Data structure design">Data structure design </option>
					<option value="Data information system">Data information system</option>
					<option value="Databases design">Databases design</option>
					</select>
                    </div>
                  </div>
